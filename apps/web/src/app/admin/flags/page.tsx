                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="font-bold text-lg text-slate-900">Bill #{flag.bill?.bill_number || 'N/A'}</span>
                                        ...
                                        <p className="text-sm text-slate-500">
                                            Flagged by <strong>{flag.guard?.full_name || 'Unknown'}</strong> on {new Date(flag.created_at).toLocaleString()}
                                        </p>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm text-slate-500">Customer</div>
                                        <div className="font-medium">{flag.bill?.customer?.full_name || 'N/A'}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-purple-700">
                                            Raised by <strong>{con.customer?.full_name || 'Unknown'}</strong> on {new Date(con.created_at).toLocaleString()}
                                        </p>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <div className="p-3 bg-white rounded border border-slate-200 text-sm">
                                            {con.flag?.reason || 'N/A'}: {con.flag?.description || ''}
                                        </div>
                                    </div>
                                    <div>
