            ...
            <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="btn w-full py-4 disabled:opacity-50 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-pink-700 transition-all"
                    >
